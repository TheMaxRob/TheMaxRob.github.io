...
const App: React.FC = () => {
  ...
  const cardsData: CardData[] = [
    // Personal Projects (with clickable links and images)
    {
      id: 1,
      name: "geoChat",
    ...
    // Professional Experience (non-clickable, no images)
    {
      id: 6,
    ...
    // Community Involvement (optional, can include link/image if desired)
    {
      id: 9,
